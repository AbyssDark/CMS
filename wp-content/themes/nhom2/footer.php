            ...
            <div class="footer-shipping pt-60 pb-55 pb-xs-25">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="<?= get_template_directory_uri() ?>/assets/images/shipping-icon/1.png"
                                    alt="Shipping Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="<?= get_template_directory_uri() ?>/assets/images/shipping-icon/2.png"
                                    alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                                <h2>Safe Payment</h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="<?= get_template_directory_uri() ?>/assets/images/shipping-icon/3.png"
                                    alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="<?= get_template_directory_uri() ?>/assets/images/shipping-icon/4.png"
                                    alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-logo">
                            <img src="<?= get_template_directory_uri() ?>/assets/images/menu/logo/1.jpg"
                                alt="Footer Logo">
                            <p class="info">
